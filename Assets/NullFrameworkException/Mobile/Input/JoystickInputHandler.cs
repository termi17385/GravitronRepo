...
namespace NullFrameworkException.Mobile.InputHandling
{
    public class JoystickInputHandler : RunnableBehaviour, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        [SerializeField] private float magnitudeLength = 1;
        ...
        public void OnDrag(PointerEventData _eventData)
        {
            ...
            float xDifference = (background.rect.size.x - handle.rect.size.x) * offset;
            float yDifference = (background.rect.size.y - handle.rect.size.y) * offset;
            ...
            Axis = Vector2.ClampMagnitude(Axis, magnitudeLength);
